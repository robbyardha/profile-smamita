...
class Kesiswaan_be extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('backend/content/kesiswaan_be/index', $data);
    ...
    public function isi_profile()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('kesiswaan_be');
        } else {
            $this->Kesiswaan_model->isi_profile();
    ...
    public function ubah_profile()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Kesiswaan_model->ubah_profile();
    ...
    public function struktur()
    {
        ...
        $this->load->view('backend/layout/sidebar', $data);
        $this->load->view('backend/layout/navbar', $data);
        $this->load->view('backend/content/kesiswaan_be/struktur', $data);
        $this->load->view('backend/layout/footer', $data);
    }
    ...
    public function tambah_struktur()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Kesiswaan_model->tambah_struktur();
            $this->session->set_flashdata('message', 'Data Berhasil ditambah');
            redirect('kesiswaan_be/struktur');
        }
    }
    public function ubah_struktur()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Kesiswaan_model->ubah_struktur();
            $this->session->set_flashdata('message', 'Data Berhasil diubah');
            redirect('kesiswaan_be/struktur');
        }
    }
    ...
    public function hapus_struktur()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Kesiswaan_model->hapus_struktur();
