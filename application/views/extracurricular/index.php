...
<div class="container">
    <h3 class="text-center my-3">Ekstrakurikuler</h3>
    <div class="row d-flex align-content-center">
        <div class="col-4">
            <div class="card mr-2 ml-2 mt-2 mb-2" style="width: 18rem;">
                <img class="rounded img-fluid" src="<?= base_url('assets/img/ekstra/basket.jpeg') ?>" alt=" SMAM1TA">
                <div class="card-body">
                    <h5 class="card-title">Basket</h5>
                </div>
            </div>
            <div class="card mr-2 ml-2 mt-2 mb-2" style="width: 18rem;">
                <img class="rounded img-fluid" src="<?= base_url('assets/img/ekstra/film.jpeg') ?>" alt=" SMAM1TA">
                <div class="card-body">
                    <h5 class="card-title">Film</h5>
                </div>
            </div>
            <div class="card mr-2 ml-2 mt-2 mb-2" style="width: 18rem;">
                <img class="rounded img-fluid" src="<?= base_url('assets/img/ekstra/pemrograman.jpeg') ?>" alt=" SMAM1TA">
                <div class="card-body">
        ...
        <div class="col-4">
            <div class="card mr-2 ml-2 mt-2 mb-2" style="width: 18rem;">
                <img class="rounded img-fluid" src="<?= base_url('assets/img/ekstra/taritradisional.jpg') ?>" alt=" SMAM1TA">
                <div class="card-body">
