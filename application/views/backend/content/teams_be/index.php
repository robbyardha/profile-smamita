<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Teams /</span> List Teams</h4>
        ...
        <div class="card">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <?php foreach ($teams as $krstr) : ?>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel1">Lihat Team <?= $krstr['nama'] ?></h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col mb-0">
                                                        <label for="bagian" class="form-label">Bagian / Jabatan</label>
                                                        <input type="text" id="bagian" name="bagian" class="form-control" value="<?= $krstr['bagian'] ?>" placeholder="Enter Deskripsi" />
                                                ...
                                                <div class="row g-2">
                                                    <div class="col mb-0">
                                                        ...
                                                        <br>
                                                        <img height="350px" src="<?= base_url('assets/file_upload/teams/') . $krstr['foto'] ?>" alt="" srcset="">
                                                    </div>
                                                </div>
                                ...
                                <div class="modal fade" id="ubah_modal<?= $krstr['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="<?= base_url('teams_be/ubah_teams') ?>" enctype="multipart/form-data" method="post">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel1">Ubah Teams <?= $krstr['nama'] ?></h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row">
                                ...
                                <div class="modal fade" id="hapus_modal<?= $krstr['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="<?= base_url('teams_be/hapus_teams') ?>" method="post">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel1">Hapus Teams <?= $krstr['nama'] ?></h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
            ...
            <div class="modal fade" id="tambah_modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form action="<?= base_url('teams_be/tambah_teams') ?>" enctype="multipart/form-data" method="post">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Tambah Teams</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                ...
                                <div class="row g-2">
                                    <div class="col mb-0">
                                        <label for="bagian" class="form-label">Bagian / Jabatan</label>
                                        <input type="text" id="bagian" name="bagian" class="form-control" placeholder="Enter Deskripsi" />
                                        <?= form_error('bagian', '<small class="text-danger">', '</small>') ?>
                                    </div>
                                </div>
