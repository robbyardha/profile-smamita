<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Ismuba /</span> Struktur</h4>
        ...
        <div class="card">
                ...
                <div class="table-responsive text-nowrap py-2 px-2">
                    <table class="table table-striped dt-responsive nowrap datatables py-1 px-1">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            $no = 1;
                            ?>
                            <?php foreach ($ismuba_struktur as $krstr) : ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?= $krstr['nama'] ?></td>
                                    <td><?= $krstr['divisi'] ?></td>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col mb-0">
                                                        ...
                                                        <br>
                                                        <img height="350px" src="<?= base_url('assets/file_upload/ismuba/struktur/') . $krstr['foto'] ?>" alt="" srcset="">
                                                    </div>
                                                </div>
                                ...
                                <div class="modal fade" id="ubah_modal<?= $krstr['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="<?= base_url('ismuba_be/ubah_struktur') ?>" enctype="multipart/form-data" method="post">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                ...
                                <div class="modal fade" id="hapus_modal<?= $krstr['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="<?= base_url('ismuba_be/hapus_struktur') ?>" method="post">
                                            <div class="modal-content">
                                                <div class="modal-header">
            ...
            <div class="modal fade" id="tambah_modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form action="<?= base_url('ismuba_be/tambah_struktur') ?>" enctype="multipart/form-data" method="post">
                        <div class="modal-content">
                            <div class="modal-header">
