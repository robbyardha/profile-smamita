                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="mb-3">
                            ...
                            <p id="tentang" class="poppins-regular"><?= $get_profile['nama_sarpras'] ?></p>
                        </div>
                        <div class="mb-3">
                            <label for="deskripsi" class="form-label">Deskripsi</label>
                            <p class="poppins-regular"><?= $get_profile['deskripsi_sarpras'] ?></p>
                        </div>
                    </div>
                    ...
                    <div class="card" style="height: 83rem;">
                        ...
                        <iframe class="responsive-iframe" control src="<?= base_url('assets/file_upload/sarpras/profile/') . $get_profile['program_kerja'] ?>" title="Program Kerja" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                            ...
                            <tbody>
                                <?php foreach ($get_struktur as $getstruk) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img height="150" width="150" src="<?= base_url('assets/file_upload/sarpras/struktur/') . $getstruk['foto'] ?>" alt="" srcset="">
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
